...
export const CreativeTemplate = ({ data }: CreativeTemplateProps) => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white text-gray-800" id="cv-preview">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-primary-600 via-blue-600 to-purple-600 text-white p-8">
      ...
      {skills.length > 0 && (
        <div className="p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Ko'nikmalar</h3>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-sm opacity-90">
                      {categorySkills.length} ko'nikma
                    </p>
                  </div>
                  <div className="p-4">
      ...
      {workExperience.length > 0 && (
        <div className="p-8 bg-gray-50">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Ish tajribasi</h3>
          </div>
      ...
      {projects.length > 0 && (
        <div className="p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Loyihalar</h3>
          </div>
      ...
      {education.length > 0 && (
        <div className="p-8 bg-gray-50">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Ta'lim</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {languages.length > 0 && (
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900">Tillar</h3>
            </div>
        ...
        {certificates.length > 0 && (
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900">Sertifikatlar</h3>
            </div>
            <div className="space-y-3">
              {certificates.map((cert, index) => (
                ...
                >
                  ...
                  {cert.year && (
                    <p className="text-gray-500 text-sm">{cert.year} yil</p>
                  )}
                  {cert.link && (
                    <a
                      href={cert.link}
